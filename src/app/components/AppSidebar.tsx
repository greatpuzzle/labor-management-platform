...
// Menu items mapping
// Mapping logic:
// 대시보드 -> Dashboard (placeholder)
// 장치 모니터링 -> Monitor (placeholder)
// 등록 -> Contract Management (Main feature, active)
// 고객 내역 -> Employee Management
// 포인트 관리 -> Settings (placeholder)
// 알림/공지 -> Notice (placeholder)
const items = [
  {
    title: "대시보드",
    url: "#",
  ...
  },
  {
    ...
    icon: MonitorIcon,
    isActive: false,
    alertMsg: "장치 모니터링 기능은 준비중입니다."
  },
  {
    title: "등록",
    url: "#",
    icon: RegisterIcon,
    isActive: true, // This maps to Contract Dashboard
    hasArrow: true
  },
  {
    title: "고객 내역",
    url: "#",
    icon: CustomerIcon,
    isActive: false, // This maps to Employee list if needed, but for now we keep 'Register' as main view
    alertMsg: "고객 내역(근로자 관리)은 '등록' 메뉴에서 통합 관리됩니다."
  },
  {
    title: "포인트 관리",
    url: "#",
...
export function AppSidebar({ user, onLogout, stampImage, setStampImage }: AppSidebarProps) {
  // Admin Info State
